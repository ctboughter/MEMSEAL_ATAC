...
for i in {1..8};
do
    singularity exec --bind /hpcdata/lisbcb/MEMSEAL/ATAC/processed/YFV_atac signac_latest.sif Rscript proc_temp_d$day.R &> proc_asap$day$i.out
    next=$[$i+1]
    zz=0
